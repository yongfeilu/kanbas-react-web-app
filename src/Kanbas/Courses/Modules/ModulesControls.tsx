...
export default function ModulesControls({ role, moduleName, setModuleName, addModule }:
  { role:string, moduleName: string; setModuleName: (title: string) => void; addModule: () => void; }) {
  return (
